...
- [ ] Worked on a full project with modules, dependencies, and tests  
...
- [ ] Working with modules and packages, imports, virtual environments  
- [ ] Asynchronous programming (async/await, asyncio)  
- [ ] Exceptions and error handling  
- [ ] Testing (pytest, unittest, mock)  
- [ ] Optimization and profiling  
- [ ] Working with external APIs / network (requests, aiohttp)  
...
- [ ] Working with remote repositories (fetch, pull, remote)  
- [ ] Pull requests and code review  
- [ ] Working with GitHub issues and project boards  
- [ ] Setting up .gitignore, README, licenses  
- [ ] Using GitHub Actions and CI/CD  
- [ ] Working with submodules or monorepos  
...
- [ ] Created own APIs (FastAPI / Flask)  
...
- [ ] Collected but did not analyze data (JSON / parsing)  
...
- [ ] Use WSL on Windows  
- [ ] Work a lot in console, use different CLIs  
...
- [ ] Used LaTeX for articles, reports, specifications, or documentation  
...
- [ ] Used aiogram  
- [ ] Used telebot  
- [ ] Wrote bots not in Python  
- [ ] Worked directly with Telegram API  
- [ ] Used FSM in bots  
...
- [ ] Use mocks (e.g., unittest.mock), integration tests  
- [ ] Set up testing in CI/CD (e.g., GitHub Actions)  
...
- [ ] Have experience with distributed team development via Git/GitHub/GitLab  
- [ ] Acted as team lead / architect in a project  
...
Describe which metrics you would propose, why, which aspects of developer work they reflect, and how they could be collected using tools like the GitHub API.  
...
Optionally, you can include a diagram of the architecture and attach a link.
